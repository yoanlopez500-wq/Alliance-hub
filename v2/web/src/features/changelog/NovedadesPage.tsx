...
const CHANGES: ChangeItem[] = [
  {
    ...
    icon: '🧭',
    impact: 'Mejora',
    title: 'Navegación reorganizada: menos enlaces, todo más a mano',
    body: 'La barra de navegación se reorganiza por completo: las ~35 opciones visibles se reducen a un puñado de cabeceras, y las páginas gemelas ahora son secciones con pestañas de una sola página.',
    bullets: [
      'Público: Partidas, Rankings (con Mercado como pestaña) y Alianzas, más un desplegable «Información» que reúne Novedades, Funciones, Reglamento y Cómo ser líder en /info.',
      'Admin: 4 desplegables (Gestión, Moderación, Competición, Config) con las herramientas filtradas por rol.',
      'Strikes+Sanciones y las tres bandejas de reportes pasan a ser pestañas; Games (v1) se unifica con Partidas.',
      'El panel de admin ahora es un hub con buscador: teclea y salta a cualquier herramienta.',
      'Todas las rutas antiguas redirigen: nada de lo compartido se rompe.',
    ],
  ...
  },
  {
    ...
    icon: '📝',
    impact: 'Nuevo',
    title: 'Notas internas de jugador con registro de autor y fecha',
    body: 'Staff y líderes de alianza pueden dejar notas escritas sobre un jugador que, a diferencia de los reportes, son privadas y llevan log de quién las puso y cuándo.',
    bullets: [
      'Las notas de staff solo las ve el staff; las de alianza solo su liderazgo.',
      'Append-only: nadie puede editar ni borrar una nota (traza completa).',
      'El líder las gestiona desde su panel (botón 📝 por miembro) y el staff desde el perfil del jugador.',
    ],
  ...
  },
  {
    ...
    icon: '📡',
    impact: 'Mejora',
    title: 'Importación por API en partidas con rate limit global',
    body: 'El detalle de partida ahora puede descargar los resultados K/D directamente del exportador externo, sin CSV manual, igual que el importador clásico.',
    bullets: [
      'Detección automática de columnas y bots (UID <= 0) excluidos.',
      'Rate limit global aplicado en servidor: máximo 1 descarga cada 15 s para todo el mundo (nunca menos de 10 s).',
      'Se probó en producción con la partida 10903600.',
    ],
    audiences: ['staff'],
  },
  {
